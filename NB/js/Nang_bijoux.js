...
function Hover_on(id, type_bijoux_min, i){
			...
			document.getElementById(id).src=`images/${type_bijoux_min}${i}_2.jpg`

		}
function Hover_off(id,type_bijoux_min,i){
			document.getElementById(id).src=`images/${type_bijoux_min}${i}.jpg`
		}
...
function id_collection(type_bijoux,nb_bjx,nom_bijoux, descr, prix) {
	...
	while (i<=nb_bjx) { 
		...
		image.className="photo-article photo-article-top";
		image.alt=`${type_bijoux} numéro${i}`;
		image.src=`images/${type_bijoux_min}${i}.jpg`
		var id_image = `photo-article-${type_bijoux}${i}`

		var image2 = document.createElement("img");
		image2.id=`photo2-article-${type_bijoux}${i}`;
		image2.className="photo-article photo-article-bottom";
		image2.alt=`${type_bijoux} numéro${i}, photo n°2`;
		image2.src=`images/${type_bijoux_min}${i}_2.jpg`
		var id_image2 = `photo2-article-${type_bijoux}${i}`
		...
		div2.className="div-photos-articles";
...
var type_bijoux_min = type_bijoux.toLowerCase()
	...
	for (var i = 1; i <= nbArticles; i++) {
		...
		img1.setAttribute('src',`images/${type_bijoux_min}${i}.jpg`);
		...
		img2.setAttribute('src',`images/${type_bijoux_min}${i}_2.jpg`);
		...
		img3.setAttribute('src',`images/${type_bijoux_min}${i}.jpg`);
